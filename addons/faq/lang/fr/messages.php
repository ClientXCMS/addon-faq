...
return [
    ...
    'formulaire' => [
        ...
        'category_help' => 'Catégorie thématique pour organiser vos FAQ sur la page principale.',
    ...
    'client' => [
        ...
        'search_placeholder' => 'Rechercher dans les FAQ...',
        'empty_search' => 'Aucun résultat trouvé',
        'empty_search_description' => 'Votre recherche n\'a donné aucun résultat. Essayez avec des termes différents.',
        'reset_search' => 'Effacer la recherche',
        'questions_count' => 'question|questions',
        'support_badge' => 'Support 24/7',
        'response_badge' => 'Réponse en 5min',
    ...
    'categories' => [
        ...
        'create' => [
            ...
            'description' => 'Créer une nouvelle catégorie de FAQ.',
        ],
        'show' => [
            'title' => 'Modifier :name',
            'description' => 'Modifier la catégorie de FAQ.',
        ],
        'formulaire' => [
            'name' => 'Nom de la catégorie',
            'slug' => 'Identifiant URL',
            'slug_help' => 'Laisser vide pour générer automatiquement depuis le nom.',
            'icon' => 'Icône',
            'icon_help' => 'Classe Bootstrap Icons (ex: bi-server, bi-shield-lock).',
        ],
        'icon' => 'Icône',
        'faqs_count' => 'Nombre de FAQ',
        'stats' => [
            'faqs_count' => '{0} Aucune FAQ|{1} 1 FAQ associée|[2,*] :count FAQ associées',
        ],
    ],
];
